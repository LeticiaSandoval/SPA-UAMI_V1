...
<div class="row">
		...
		<form method="post" action="<?php echo base_url();?>/principal_libro/actualizarLibro">
		<div class="myform-top">
			...
			<div class="form-group" col-lg-8>
				<label>ID</label>
				<input type="text" readonly="true" class="form-control" name="id_artLibCapítulo" value="<?php echo $Libro->id_artLibCapítulo;?>">
			</div>
			<div class="form-group" col-lg-8>
				<label>Titulo del Articulo</label>
				<input type="text" class="form-control" name="titulo_articulo" required="true" value="<?php echo $Libro->titulo_articulo;?>">
			</div>	
			<div class="form-group" col-lg-8>
				<label>Autores</label>
			...
			<div class="form-group" col-lg-8>
				...
				<input type="text" name="título_del_libro" class="form-control" required="true" value="<?php echo $Libro->título_del_libro;?>">
			</div>
			<div class="form-group" col-lg-8>
				<label>Numero del Capitulo</label>
				<input type="text" name="núm_del_capítulo" class="form-control" required="true" value="<?php echo $Libro->núm_del_capítulo;?>">
			</div>
			<div class="form-group" col-lg-8>
			...
			<div class="form-group" col-lg-8>
				...
				<input type="text" name="pág_ini" class="form-control" required="true" value="<?php echo $Libro->pág_ini;?>">
			</div>
			<div class="form-group" col-lg-8>
				<label>Pagina Fin</label>
				<input type="text" name="pág_fin" class="form-control" required="true" value="<?php echo $Libro->pág_fin;?>">
			</div>
